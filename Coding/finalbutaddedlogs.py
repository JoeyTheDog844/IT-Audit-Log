...
buttons = ["Home", "System Info", "Network Details", "Windows Updates", "Desktop Files", "Live System Monitor", "Clear Cache", "Security Logs", "System Logs", "Application Logs", "DNS Logs", "USB Logs"]
for btn in buttons:
